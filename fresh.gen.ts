...
import * as $7 from "./routes/api/[entLookup]/status/index.ts";
import * as $8 from "./routes/api/[entLookup]/users.ts";
...
const manifest = {
  routes: {
    ...
    "./routes/api/[entLookup]/status/index.ts": $7,
    "./routes/api/[entLookup]/users.ts": $8,
